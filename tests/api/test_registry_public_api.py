...
def test_filetype_register_unregister_roundtrip(dummy_name: str) -> None:
    ...
    ft = stub_ft(dummy_name, description="Stub FT")
    ...
    try:
        ...
        names = {m.name for m in FileTypeRegistry.iter_meta()}
...
def test_processor_register_unregister_roundtrip(proc_name: str) -> None:
    ...
    try:
        ...
        names = {m.name for m in HeaderProcessorRegistry.iter_meta()}

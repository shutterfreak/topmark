...
- it does make summary, exit-code, and report-scope filtering logic testable against durable results
  without changing current CLI, API, human-output, probe-output, or machine-detail contracts.

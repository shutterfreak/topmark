...
> [!NOTE] This page contains a **curated subset** of the internal API. The authoritative API
> reference is generated by `tools/docs/gen_api_pages.py` and is available under

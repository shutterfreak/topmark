...
- [`topmark config defaults`](./config/defaults.md) — show the *built-in* default configuration.
- [`topmark config init`](./config/init.md) — print a *starter* configuration file based on the

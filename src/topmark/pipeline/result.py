...
class ProcessingDetailSnapshot:
    ...
    or updated file images, processors, configuration objects, or other runtime
    state owned by [`ProcessingContext`][topmark.pipeline.context.model.ProcessingContext].
